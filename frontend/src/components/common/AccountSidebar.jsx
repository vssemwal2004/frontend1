import { X, List, User, Wallet, Tag, ChevronRight, LogOut } from 'lucide-react';
          ...
          {!user ? (
            ...
            <div className="p-6 border-b border-neutral-200">
              ...
              <button
                ...
                className="block w-full bg-red-600 hover:bg-red-700 text-white text-center font-semibold py-4 rounded-lg transition-colors"
              >
                Sign In
              </button>
              <p className="text-neutral-900 mt-4 text-center">
                Don't have an account?{' '}
                <button
                  onClick={() => handleOpenLogin('signup')}
                  className="text-neutral-900 underline font-semibold hover:text-red-600"
                >
                  Sign up
                </button>
              </p>
            ...
            <div className="p-6 border-b border-neutral-200 bg-gradient-to-br from-red-50 to-orange-50">
